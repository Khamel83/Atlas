class TemporalEngine:
    ...
    def _analyze_seasonal_patterns(self, temporal_patterns):
        ...
        peak_periods = [period for period, volume in content_volume.items() if volume > avg_volume * 1.5]
        low_periods = [period for period, volume in content_volume.items() if volume < avg_volume * 0.5]
    ...
    def _calculate_content_velocity(self, temporal_patterns):
        ...
        return {
            ...
            'velocity_classification': self._classify_velocity(growth_analysis.get('growth_rate_percent', 0))
        }
    ...
    def get_time_aware_relationships(self, max_delta_days=1):
        ...
        return [(rel['item1'], rel['item2'], rel['time_delta_days']) for rel in relationships]
