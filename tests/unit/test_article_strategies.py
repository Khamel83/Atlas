...
class TestDirectFetchStrategy:
    ...
    def test_fetch_http_error(self, strategy, mock_requests):
        ...
        mock_requests['get'].return_value.raise_for_status.side_effect = Exception("404 Not Found")
...
class TestPlaywrightStrategy:
    ...
    def test_fetch_success(self, strategy, mock_playwright, sample_article_html):
        ...
        mock_playwright['page'].goto.assert_called_once_with(url, wait_until='networkidle')
...
class TestArticleFetcher:
    ...
    @pytest.mark.unit
    def test_fetch_success_first_strategy(self, fetcher, mock_requests, sample_article_html):
    ...
    @pytest.mark.unit
    def test_fetch_fallback_strategies(self, fetcher, mock_requests, sample_article_html):
    ...
    def test_fetch_all_strategies_fail(self, fetcher, mock_requests):
        ...
        with patch('helpers.article_strategies.sync_playwright') as mock_playwright:
            mock_playwright.return_value.__enter__.return_value.chromium.launch.side_effect = Exception("Browser error")
    ...
    def test_get_available_strategies(self, fetcher):
        ...
        expected_strategies = ["direct", "12ft.io", "archive.today", "googlebot", "playwright", "wayback"]
        assert strategies == expected_strategies
    
    @pytest.mark.unit
    def test_fetch_with_specific_strategy(self, fetcher, mock_requests, sample_article_html):
