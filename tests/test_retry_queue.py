...
class TestRetryQueue:
    ...
    def test_enqueue_dequeue_integration(self, temp_queue_dir):
        ...
        task1 = {"type": "test1", "url": "https://example1.com", "error": "Test error 1"}
        task2 = {"type": "test2", "url": "https://example2.com", "error": "Test error 2"}
    ...
    def test_unicode_handling(self, temp_queue_dir):
        ...
        task = {"type": "test", "url": "https://example.com/üñîçøðé", "error": "Üñîçøðé error"}
