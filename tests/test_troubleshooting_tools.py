...
class TestEnvironmentDiagnostic:
    ...
    def test_python_version_check(self):
        ...
        critical_issues = [issue for issue in self.diagnostic.issues 
    ...
    def test_project_structure_check(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            missing_files = [issue for issue in self.diagnostic.issues 
    ...
    def test_configuration_check_missing_env(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            env_issues = [issue for issue in self.diagnostic.issues 
    ...
    def test_configuration_check_with_env(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            info_messages = [msg for msg in self.diagnostic.info 
                           if 'Configuration file found' in msg]
    ...
    def test_permissions_check(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            success_messages = [msg for msg in self.diagnostic.info 
    ...
    def test_disk_space_check(self):
        ...
        disk_messages = [msg for msg in self.diagnostic.info + 
    ...
    def test_network_connectivity_check(self):
        ...
        network_messages = [msg for msg in self.diagnostic.info + 
                          [w['issue'] for w in self.diagnostic.warnings] +
                          [i['issue'] for i in self.diagnostic.issues]
    ...
    def test_fix_permissions(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            fix_messages = [msg for msg in self.diagnostic.fixes 
