...
from helpers.config import load_config, load_categories, get_config, is_feature_enabled, get_model_for_task
...
class TestConfigurationLoading:
    ...
    def test_load_config_basic(self):
        ...
        required_keys = [
            "data_directory", "article_output_path", "podcast_output_path", 
            "youtube_output_path", "llm_provider", "llm_model"
        ]
    ...
    def test_load_config_path_construction(self):
        ...
        with patch.dict(os.environ, test_env, clear=False):
            ...
            assert config["article_output_path"] == os.path.join("custom_output", "articles")
            assert config["podcast_output_path"] == os.path.join("custom_output", "podcasts")
            assert config["youtube_output_path"] == os.path.join("custom_output", "youtube")
...
class TestConfigurationEdgeCases:
    ...
    def test_empty_environment_variables(self):
        ...
        with patch.dict(os.environ, test_env, clear=False):
            ...
            assert config["data_directory"] == "output" or config["data_directory"] == ""
...
class TestIngestorConfiguration:
    ...
    def test_ingestor_defaults(self):
        ...
        ingestor_vars = [
            "ARTICLE_INGESTOR_ENABLED", "PODCAST_INGESTOR_ENABLED",
            "YOUTUBE_INGESTOR_ENABLED", "INSTAPAPER_INGESTOR_ENABLED",
