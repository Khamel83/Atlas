...
from ingest.link_dispatcher import detect_url_type, is_duplicate, dispatch_url, process_url_list
...
class TestLinkDispatcher:
    ...
    def test_is_duplicate(self, mock_exists, mock_link_uid):
        ...
        mock_exists.assert_any_call(os.path.join("output/articles", "metadata", "1234567890abcdef.json"))
    ...
    def test_dispatch_url(self, mock_detect_url_type, mock_is_duplicate):
        ...
        success, message = dispatch_url("https://podcasts.apple.com/podcast/123", config)
        assert success == False
