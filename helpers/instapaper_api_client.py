    ...
    def authenticate(self, username: str, password: str) -> bool:
        ...
        try:
            ...
            if access_token and access_token_secret:
                ...
                print(f"Authentication failed: Missing tokens in response. Response: {response.text}")
                return False
        except requests.exceptions.RequestException as e:
            print(f"Authentication failed: {e}")
            return False

    def list_bookmarks(self, limit: int = 25, folder: str = "unread") -> List[Dict[str, Any]]:
        """
...
if __name__ == "__main__":
    ...
    CONSUMER_SECRET = os.environ.get("INSTAPAPER_CONSUMER_SECRET", "YOUR_CONSUMER_SECRET")
    INSTAPAPER_USERNAME = os.environ.get("INSTAPAPER_USERNAME", "YOUR_INSTAPAPER_USERNAME")
    INSTAPAPER_PASSWORD = os.environ.get("INSTAPAPER_PASSWORD", "YOUR_INSTAPAPER_PASSWORD")
