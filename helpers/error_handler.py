...
"""
        ...
        if "## Post-Task Checklist:" in content:
            content = content.replace("## Post-Task Checklist:", new_entry + "\n## Post-Task Checklist:")
        else:
            content += new_entry
...
def handle_network_error(url: str, 
                        status_code: int, 
...
def handle_file_system_error(file_path: str,
                            exception: Exception,
                            error_handler: AtlasErrorHandler,
                            log_path: str,
                            module_name: str,
