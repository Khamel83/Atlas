...
CONTEXTS = ["ArticleFetcher", "PodcastIngestor", "YoutubeDownloader", "TranscriptionService", "MainPipeline"]
HTTP_ERRORS = ["403 Forbidden", "404 Not Found", "500 Internal Server Error", "401 Unauthorized"]
FILE_ERRORS = ["FileNotFoundError: /data/input.csv", "PermissionError: /app/config.yaml"]
API_ERRORS = ["APIKeyInvalid: Your API key has expired.", "RateLimitExceeded: 200 requests/min"]
SUCCESS_MESSAGES = ["Successfully processed item", "Ingestion complete for source", "Transcript downloaded", "Metadata saved"]
WARNING_MESSAGES = ["Skipped item due to existing record", "Retrying in 5s", "Configuration value 'X' is deprecated"]
