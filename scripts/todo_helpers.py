...
from scripts.unified_todo_manager import UnifiedTodoManager, TodoStatus, TodoPriority, TodoSource
...
def add_todo(content: str, priority: str = "medium", category: str = "general", 
             source: str = "master", estimated_time: int = None, 
...
def get_todos(status: str = None, priority: str = None, category: str = None, 
...
def add_dev_todo(content: str, priority: str = "medium", estimated_time: int = 30) -> str:
    """Add a development TODO."""
    return add_todo(content, priority=priority, category="development", 
                   source="dev_workflow", estimated_time=estimated_time)

def add_bug_todo(content: str, priority: str = "high") -> str:
    """Add a bug TODO."""
    return add_todo(content, priority=priority, category="bug", 
                   source="dev_workflow", tags=["bug"])

def add_feature_todo(content: str, priority: str = "medium", estimated_time: int = 60) -> str:
    """Add a feature TODO."""
    return add_todo(content, priority=priority, category="feature", 
                   source="dev_workflow", estimated_time=estimated_time, tags=["feature"])

def add_doc_todo(content: str, priority: str = "low") -> str:
    """Add a documentation TODO."""
    return add_todo(content, priority=priority, category="documentation", 
                   source="documentation", tags=["docs"])

def add_health_todo(content: str, priority: str = "medium") -> str:
    """Add a health check TODO."""
    return add_todo(content, priority=priority, category="health", 
                   source="health_check", tags=["health"])
...
def example_usage():
    ...
    feature_id = add_feature_todo("Add dark mode support", priority="medium", estimated_time=120)
