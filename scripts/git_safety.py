...
def check_git_status():
    ...
    try:
        ...
        if result.stdout.strip():
            ...
            if response.lower() == 'y':
                try:
                    ...
                    commit_msg = input("Commit message (or press Enter for auto message): ")
        ...
        try:
            subprocess.run(["git", "ls-remote", "--heads", "origin"], 
...
def enforce_commit_frequency():
    ...
    try:
        ...
        if minutes_since_commit > 30:
            print(f"⚠️  WARNING: Last commit was {minutes_since_commit:.0f} minutes ago!")
            print("🔔 Consider committing your work more frequently (every 15-20 minutes)")
            return False
