...
def check_python_version():
    ...
    if version.major >= 3 and version.minor >= 9:
        print_status(f"Python {version.major}.{version.minor}.{version.micro} meets requirements", "success")
        return True
    else:
...
def main():
    ...
    if passed == total:
        ...
        print_status("For detailed diagnostics, run: python scripts/diagnose_environment.py", "info")
        return False
