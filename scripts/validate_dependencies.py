...
class DependencyValidator:
    ...
    def __init__(self, project_root: Path = None):
        ...
        self.optional_packages = [
            "pytest", "black", "isort", "mypy", "playwright", "redis", "openai"
        ]
        ...
        self.system_dependencies = [
            ...
            {"name": "redis-server", "command": "redis-server --version", "required": False}
        ]

    def validate_all(self, fix_issues: bool = False, verbose: bool = False) -> Dict[str, Any]:
        """
    ...
    def _validate_python_version(self, verbose: bool):
        ...
        try:
            ...
            if version.major >= required_major and version.minor >= required_minor:
                ...
                if verbose:
                    print(f"  ❌ Python {version.major}.{version.minor}.{version.micro} (need {required_major}.{required_minor}+)")
    ...
    def _validate_required_packages(self, fix_issues: bool, verbose: bool):
        ...
        if missing_packages:
            self.results["required_packages"]["details"]["suggestion"] = (
    ...
    def _validate_optional_packages(self, verbose: bool):
        ...
        if missing_packages:
            self.results["optional_packages"]["details"]["suggestion"] = (
    ...
    def _validate_directories(self, fix_issues: bool, verbose: bool):
        ...
        required_dirs = [
            "output", "output/articles", "output/youtube", "output/podcasts",
            "config", "logs", "tests"
        ]
    ...
    def _generate_overall_assessment(self, verbose: bool):
        ...
        failed_categories = [
            category for category, result in self.results.items()
        ...
        if verbose:
            if overall_status == "pass":
                ...
                print(f"  ❌ {len(issues)} issues found in {len(failed_categories)} categories")
